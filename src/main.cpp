...
static const int64 nTargetTimespan = 4 * 60 * 60; // NetCoin: 4 hour difficulty readjustment
static const int64 nTargetSpacing = 60; // NetCoin: 1 minute block targets
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "NetCoin 2021";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
