...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to NetCoin server / RPC client
            std::string strUsage = _("NetCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  netcoin [options]                     " + "\n" +
                  "  netcoin [options] <command> [params]  " + _("Send command to -server or netcoin") + "\n" +
                  "  netcoin [options] help                " + _("List commands") + "\n" +
                  "  netcoin [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: netcoin.pid)") + "\n" +
